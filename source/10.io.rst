...
来从位置 ``a`` 开始到位置 ``b``
结束来\ `对序列进行切片 <https://github.com/WuShichao/a-byte-of-python-bnu/tree/4e7952bd0b5a028cd3149f9b9cff837f08531314/12.data_structures.md#sequence>`__
...
接下来，我们重新在阅读模式下打开同一个文件。我们不需要特别指定某种模式，因为“阅读文本文件”是默认的。我们在循环中使用
``readline``
...
现在你可以忽略 ``import``
语句，我们会在\ `模块章节 <https://github.com/WuShichao/a-byte-of-python-bnu/tree/4e7952bd0b5a028cd3149f9b9cff837f08531314/11.modules.md#modules>`__\ 章节探讨有关它的更多细节。
